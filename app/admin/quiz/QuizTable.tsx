    ...
    <div className="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg p-4 shadow-sm">
      ...
      <div className="flex items-center gap-2 pt-3 border-t dark:border-gray-700">
        ...
        <a
          ...
          className="flex-1 inline-flex items-center justify-center gap-1.5 px-3 py-2 text-sm font-medium text-green-700 dark:text-green-300 bg-green-50 dark:bg-green-900/30 rounded-lg hover:bg-green-100 dark:hover:bg-green-900/50 transition-colors focus:outline-none focus:ring-2 focus:ring-green-500"
        >
          <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
  ...
  if (quizzes.length === 0) {
    return (
      <div className="text-center py-12 bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-lg">
        ...
        <p className="text-gray-500 dark:text-gray-400">Create your first quiz to get started.</p>
      </div>
    );
  }
        ...
        <div className="w-full overflow-x-auto overflow-y-hidden rounded-lg shadow-sm border border-gray-200 dark:border-gray-700">
          <table className="w-full whitespace-nowrap">
            ...
            <tbody className="bg-white dark:bg-gray-900 divide-y divide-gray-200 dark:divide-gray-700">
              {quizzes.map((quiz) => (
                <tr key={String(quiz._id)} className="hover:bg-gray-50 dark:hover:bg-gray-800">
                  <td className="px-4 py-3">
                    <div className="flex items-center gap-2">
                      <span className="font-semibold text-gray-900 dark:text-gray-100 truncate max-w-md">
                        {quiz.title}
                      </span>
                      {quiz.isPublished !== undefined && (
                        <Badge variant={quiz.isPublished ? "success" : "neutral"} size="sm">
                  ...
                  <td className="px-4 py-3">
                    <span className="block text-sm text-gray-600 dark:text-gray-400 max-w-xs truncate" title={quiz.description}>
                      {quiz.description || "-"}
                    </span>
                  </td>
                  <td className="px-4 py-3 sticky right-0 z-10 bg-white dark:bg-gray-900">
                    <div className="flex items-center justify-end gap-1">
                      <a
                        ...
                        className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium text-blue-600 dark:text-blue-400 hover:text-blue-800 dark:hover:text-blue-300 hover:bg-blue-50 dark:hover:bg-blue-900/30 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
                      >
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-1 px-2.5 py-1.5 text-xs font-medium text-green-600 dark:text-green-400 hover:text-green-800 dark:hover:text-green-300 hover:bg-green-50 dark:hover:bg-green-900/30 rounded-md transition-colors focus:outline-none focus:ring-2 focus:ring-green-500"
                      >
                        <svg className="w-3.5 h-3.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z" />
